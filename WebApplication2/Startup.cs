        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(
                c =>
                {
                    ...
                    {
                        Title = "Desafio Técnico SoftPlan - Marcos Pinello - API 2",
                        Version = PlatformServices.Default.Application.ApplicationVersion,
                        Description = "Get repository and interest rates calculations.",
                    ...
                    c.IncludeXmlComments(Path.Combine(PlatformServices.Default.Application.ApplicationBasePath, $"WebApplication2.xml"));
                });
        }
